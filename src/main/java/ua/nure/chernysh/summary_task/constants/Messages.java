...
public class Messages {
    ...
    public static final String ERR_CANNOT_DELETE_SUBSCRIPTION = "subscriptionDelete.error";
    public static final String ERR_SUBSCRIPTION_END = "subscriptionEnd.error";
